...
import {BlogMeta, Blogs} from "../../types/apis";
                                    ...
                                    <div className="flex items-center justify-between mt-4">
                                        ...
                                        <div>
                                            <a href="#" className="flex items-center">
                                                <img src={blog.image}  alt="tag" className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"/>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col max-w-sm px-6 py-4 mx-auto bg-white rounded-lg shadow-md">
                                <ul className="-mx-4">
                                    <li className="flex items-center">
                                        <img src={`./image/AWS-logo-2.jpeg`}  alt="tag" className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"/>
                                        <p>
                                    ...
                                    <li className="flex items-center mt-6">
                                        <img src={`./image/go-logo.png`}  alt="tag" className="hidden object-contain scale-75 w-10 h-10 mx-4 rounded-full sm:block"/>
                                        <p><a href="#"
                                    ...
                                    <li className="flex items-center mt-6">
                                        <img src={`./image/java-logo.png`}  alt="tag" className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"/>
                                        <p><a href="#" className="mx-1 font-bold text-gray-700 hover:underline">Java</a><span
                                            className="text-sm font-light text-gray-700">0 Posts</span></p>
                                    </li>
                                    <li className="flex items-center mt-6"><img src={`./image/system-logo.png`}  alt="tag" className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"/>
                                        <p><a href="#" className="mx-1 font-bold text-gray-700 hover:underline">System
                                            design</a><span
                                            className="text-sm font-light text-gray-700">0 Posts</span></p>
                                    </li>
                                    <li className="flex items-center mt-6"><img src={`./image/LeetCode_logo.png`}  alt="tag" className="hidden object-cover w-10 h-10 mx-4 rounded-full sm:block"/>
                                        <p><a href="#"
