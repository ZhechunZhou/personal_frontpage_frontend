...
export const HomePage: React.FC = () => {
    let fgRef = useRef<ForceGraphMethods>();
    const [graph, setGraph] = useState({} as GraphData);
    const getGraph = () => {
        fetch('./json/forceGraph.json', {
            headers: {
    ...
    return (<><Navbar/>
                ...
                <div className="flex-auto ml-32 mr-40 mt-28">
                    <div className="max-w-2xl px-6 text-left mx-auto">
                        ...
                        <p className="text-gray-600 mt-4">I am a book reader, a code crafter and a happy octocat!
                            ...
                            <a
                                className={
                                    "mx-1 bg-indigo-600 text-white rounded hover:text-gray-300 inline-flex font-bold p-1.5 my-1"}
                                href="https://www.linkedin.com/in/zhechun-zhou-6a8564148/">
                                Contact me?
                            </a>
                            <Link
                                className={
                                    "mx-1 bg-gray-200 text-gray-400 rounded hover:text-gray-800 inline-flex font-bold p-1.5 my-1"}
                                to="/blogs">
                                see what I can do?
                            </Link>
                        </p>
        ...
        <section className="z-30 bg-black pattern py-20">
            ...
            <div className="max-w-5xl px-6 mx-auto text-center">
                ...
                <p className="text-gray-400 mt-4">Andy is a graduating Student in CMU looking for an Software
                    Engineering position. </p>
                <p className="text-gray-400 mt-4">Andy is a easy-going person willing to meet all sorts of people.</p>
                <p className="text-gray-400 mt-4">Andy develops decent full stack Web Applications like this one.</p>
            </div>
        </section>
